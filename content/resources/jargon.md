...
All the other intervarsity tournaments that aren't majors. New Zealand's minors are WGM, Thropy, Claytons, NZBP, Auckland IV, and occasionally other tournaments.
...
In rounds are open to everyone. After a number of in rounds the break is announced. After this the tournament moves into the out rounds, usually semi-finals and finals in which only a subsection get to speak.

## Breaking

Making it through to the out rounds. The break is the group of teams who make it through. 

## Ameteurs / Ams

Fairly self explanatory, people who are new. Some tournaments limit team structure, such as as Proams, or am only tournaments like thropy. Check the [tournament guide](tournament-guide) for specifics.
...
A tournament in which teams much be made up of a mixture of pros and ams. Usually 1 pro and 2 ams in a team of 3. Check the [tournament guide](/resources/tournament-guide) for specifics.
...
When the timetable of a tournament is adjusted to compensate for running late. This is extremely common.

# Parts of a Speech

## Analysis

The logic and reasoning that leads to and backs up an argument

## Substantive

New arguments and analysis that create a case for or against a motion.

## Rebuttal

The response and counter-argument to a teams substantive or analysis.

## Burden / Path to Victory

What a team needs to prove in order to win the debate.

## Model

The plan proposed by a team to get an outcome. This could include the laws that will be changed, where funding will be allocated, or anything else that will change how the system works Typically used by the affirmative.
...
The motivations and powers of any parties involved in the debate.

## Context

The things the judge needs to understand for a point to make sense.

## Mechanism

The explanation of why something is true. 

## Assertion

Claiming something is true without explaining why. This is bad.

## Weighing

The explanation of the why the outcomes of the mechanisms are important in the world of the debate.

## Meta

The explanation of the impact of a point on other points within the debate. This could be highlighting that a line of rebuttal undermines the key point of the oppositions case, or that this material explains a missing link in a previous speech.

## Actor

A person or organisation who is significant in the debate. It is important to explain the factors that influence an actor and what they value, and so what they will do and what the adj should weight as more important.
...
When a team speaks with fewer members than is required. This means each speaker has to do multiple speeches. Typically teams are only allowed one speaker missing, and only for a limited number of debates. Usually one speaker will do first and third, and the other will do second and leaders.
...
When a speaker takes the opposition at their best and still prove why they're wrong. This means accepting all their wild assertions, undermeched points, and moon logic, and explaining why all of that doesn't matter. This is the opposite of strawmanning.
